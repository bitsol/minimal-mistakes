...
{% gist e23d018b2d6318105c06b1fe8054eb1f %}

### Technical Credits
The source code for the website can be found by clicking the link above, and was forked from the amazing [minimal-mistakes](https://github.com/mmistakes/minimal-mistakes) theme. As of now it is hosted on [Netlify](http://netlify.com/) (many thanks) and is built with Jekyll.
